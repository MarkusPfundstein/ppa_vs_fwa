...
const option::Descriptor usage[] = {
	...
	{ UNI_MIN_BOUND,   0, "u", "uni-min-bound",    Arg::Numeric,  "  -u <arg>, \t--uni-min-bound=<arg>  \tmin bound for uniform coordinate system" },
	{ UNI_MAX_BOUND,   0, "v", "uni-max-bound",    Arg::Numeric,  "  -v <arg>, \t--uni-max-bound=<arg>  \tmax bound for uniform coordinate system" },
...
bool getParameters(option::Option *options, Parameters **p)
{
	...
	int dimensions = getNumericArg(options, DIMENSIONS, 2);
